...
//tess
    ...
    public IO(JTextField nama,JTextField lokasi,JTextField fakultas,JTextField jurusan,JTextField panjang,JTextField lebar,JTextField kursi,JTextField pintu,JTextField jendela){
        ...
        a = new setget(ini.getNama_ruang(),ini.getLokasi_ruang(),ini.getFakultas(),ini.getPanjang_ruang(),ini.getLebar_ruang(),ini.getJumlah_kursi(),ini.getJumlah_pintu(),ini.getJumlah_jendela()); 
    }
    public IO(JCheckBox Kokoh,JCheckBox TKokoh,JCheckBox Adakunci,JCheckBox Tkunci,JCheckBox Aman,JCheckBox Bahaya){
        ...
        a = new setget(ini.getKekokohan(),ini.getKuncipintujendela(),ini.getBahaya(),null); 
    ...
    public IO(JTextField Bising,JTextField PBising,JTextField Bau,JTextField PBau,JTextField Aus,JTextField PAus,JCheckBox BBanyak,JCheckBox BSedang,JCheckBox BSedikit,JCheckBox BNon,JCheckBox RBanyak,JCheckBox RSedang,JCheckBox RSedikit,JCheckBox RNon){
        if(BBanyak.isSelected()){
            ini.setKebocoran("Sangat Parah");
        }
        else if(BSedang.isSelected()){
            ini.setKebocoran("Parah");
        }
        else if(BSedikit.isSelected()){
            ini.setKebocoran("Tidak Begitu Parah");
        }
        else if(BNon.isSelected()){
            ini.setKebocoran("Keadaan Baik");
        }
            if(RBanyak.isSelected()){
                ini.setKerusakan("Sangat Parah");
            }
            else if(RSedang.isSelected()){
                ini.setKerusakan("Parah");
            }
            else if(RSedikit.isSelected()){
                ini.setKerusakan("Tidak Begitu Parah");
            }
            else if(RNon.isSelected()){
                ini.setKerusakan("Keadaan Baik");
            }
        ini.setKebisingan(Bising.getText());
        ini.setKeausan(Aus.getText());
        ini.setBau(Bau.getText());
        //String Kebisingan, String Bau, String Kebocoran, String Kerusakan, String Keausan, String x
        a = new setget(ini.getKebisingan(),ini.getBau(),ini.getKebocoran(),ini.getKerusakan(),ini.getKeausan(),0); 
    }         
    public IO(){
...
//        System.out.println("kunci pintu jendela");
//        ini.setKuncipintujendela(in.next());
//        System.out.println("bahaya atau aman ?");
//        ini.setBahaya(in.next());
//        a = new setget(ini.getKekokohan(), ini.getKuncipintujendela(), ini.getBahaya());
//
//    }
//    
//    @Override
